 ...
 */
public class IncrementalUpdaterCdcCatchUpSpec {
    ...
    public void testUpdaterSkipIfImporterNotStarted() throws SQLException {
        ...
        try {
            mockIncrementalUpdater.cdcCatchUp(mockConnection, tableRef, BigInteger.ONE, BigInteger.ONE, ZoneOffset.UTC);
    ...
    public void testUpdaterProceedIfImporterStarted() throws SQLException {
        ...
        try {
            mockIncrementalUpdater.cdcCatchUp(mockConnection, tableRef, BigInteger.ONE, BigInteger.ONE, OffsetDateTime.now(ZoneId.systemDefault()).getOffset());
            // Use import begin time, not finish time, to discard update record before import start
